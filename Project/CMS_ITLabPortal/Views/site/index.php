 ...
 *
 * Цей файл відповідає за завантаження останніх новин з бази даних та відображення їх на головній сторінці.
 * @var TYPE_NAME $latestNews Останні 5 записів новин, отриманих з БД за допомогою пагінації
 */

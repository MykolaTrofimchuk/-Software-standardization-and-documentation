 ...
 *
 * Цей файл відповідає за відображення форми реєстрації для нового користувача.
 * @var string $error_message Повідомлення про помилку, яке може бути виведене на сторінці реєстрації
 * @var string $this->Title Заголовок сторінки, встановлюється як "Реєстрація користувача"
 */
